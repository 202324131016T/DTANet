...
matplotlib.use('Agg')
# my_experiment
from model.model_att3 import net
'''
Ablation Study: model.model1_att3
Ablation Study: model.model2_att_cross_scale
Ablation Study: model.model3_no_att
Ablation Study: model.model4_att3_cross_scale
model.model_att3
model.model_block
'''
...
if __name__ == "__main__":
    ...
    print("current setting(2:drug 3:proteins):", FLAGS.problem_type)
    print("current dataset_path:", FLAGS.dataset_path)
    print("current epoch:", FLAGS.num_epoch)
    print("current lr:", FLAGS.lr)
    print("current batch_size:", FLAGS.batch_size)
    print("current drug max len:", FLAGS.max_smi_len)
    print("current target max len:", FLAGS.max_seq_len)
    print("current only test?:", FLAGS.only_test)
    ...
    print("FLAGS.result_path", FLAGS.result_path)
